import UIKit
class LMRMRankListCell: LMBaseTableViewCell {
    ...
    private lazy var arrowimv: UIImageView = {
        let imv = UIImageView(image: UIImage(named: "rm_rank_arrow"))
        return imv
    }()
...
private extension LMRMRankListCell {
    func setViewSnp() {
...
extension LMRMRankListCell {
    func setDataSoure(_ model:VoiceRankItem) {
        ...
        if model.showType == 0 {
            ...
            let attributedString = NSMutableAttributedString(string: text, attributes: [.foregroundColor: lmColorHex("#FFFFFF", alpha: 0.4)])
            attributedString.append(NSAttributedString(string: valueText, attributes: [.foregroundColor: UIColor.white]))
