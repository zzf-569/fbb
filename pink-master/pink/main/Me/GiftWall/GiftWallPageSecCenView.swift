...
class GiftWallPageSecCenView: UIView {
    ...
    private func setViewSnp() {
        ...
        giftIcon.snp.makeConstraints { make in
            ...
            make.size.equalTo(CGSize(width: kScaleWidth(44), height: kScaleWidth(44)))
        }
        giftName.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalToSuperview().offset(kScaleWidth(60))
        ...
        coinView.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalToSuperview().offset(kScaleWidth(86))
            make.height.equalTo(kScaleWidth(16))
        }
    }
    func setDataSoure() {
