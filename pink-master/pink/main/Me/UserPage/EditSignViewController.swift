...
class EditSignViewController: LMBaseVC {
    ...
    @objc func save() {
        ...
        UserNetWork.updateUserInfo(signature: name).lmrequest {[weak self] _ in
            LMToast.hide()
