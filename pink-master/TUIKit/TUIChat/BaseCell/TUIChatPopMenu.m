...
- (void)setupContainerPosition {
    ...
    CGFloat containerY = self.arrawPoint.y;
    ...
    self.arrowLayer.cornerRadius = 9;
    self.arrowLayer.fillColor = TUIChatDynamicColor(@"chat_pop_menu_bg_color", @"#000000E0").CGColor;
    if (top) {
    ...
    self.actionsView.layer.cornerRadius = 9;
}
...
- (void)prepareContainerView {
    ...
    self.actionsView.backgroundColor = TUIChatDynamicColor(@"chat_pop_menu_bg_color", @"#000000E0");
...
- (UIButton *)buttonWithAction:(TUIChatPopMenuAction *)action tag:(NSInteger)tag {
    ...
    [actionButton setTitleColor:TUIChatDynamicColor(@"chat_pop_menu_text_color", @"#FFFFFFF5")
